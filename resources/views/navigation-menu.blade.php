<nav x-data="{ open: false }" class="bg-black border-gray-100">
    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8 lg:fixed  w-full bg-black text-center">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="/works" :active="request()->routeIs('/works')">
                Works
            ...
            <div class="mt-10 pt-10 text-center grid grid-cols-3 gap-4 grid-flow-row auto-rows-min place-items-center">
                <x-jet-nav-link>
                    <x-bi-github/>
                </x-jet-nav-link>
                <x-jet-nav-link>
